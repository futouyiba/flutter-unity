 ...
 */
ZEGOEXP_API zego_error EXP_CALL zego_express_destroy_range_audio(enum zego_range_audio_instance_index instance_index);
 ...
 * @param instance_index range audio instance index
 */
ZEGOEXP_API zego_error EXP_CALL zego_express_range_audio_set_audio_receive_range(float range, enum zego_range_audio_instance_index instance_index);
 ...
 * @param instance_index range audio instance index
 */
ZEGOEXP_API zego_error EXP_CALL zego_express_range_audio_update_self_position(float position[3], float axis_forward[3], float axis_right[3], float axis_up[3], enum zego_range_audio_instance_index instance_index);
 ...
 * @param instance_index range audio instance index
 */
ZEGOEXP_API zego_error EXP_CALL zego_express_range_audio_update_audio_source(const char * userid, float position[3], enum zego_range_audio_instance_index instance_index);
 ...
 * @param instance_index range audio instance index
 */
ZEGOEXP_API zego_error EXP_CALL zego_express_range_audio_enable_spatializer(bool enable, enum zego_range_audio_instance_index instance_index);
 ...
 * @param instance_index range audio instance index
 */
ZEGOEXP_API zego_error EXP_CALL zego_express_range_audio_enable_microphone(bool enable, enum zego_range_audio_instance_index instance_index);
 ...
 * @param instance_index range audio instance index
 */
ZEGOEXP_API zego_error EXP_CALL zego_express_range_audio_enable_speaker(bool enable, enum zego_range_audio_instance_index instance_index);
 ...
 * @param instance_index range audio instance index
 */
ZEGOEXP_API zego_error EXP_CALL zego_express_set_range_audio_mode(enum zego_range_audio_mode mode, enum zego_range_audio_instance_index instance_index);
 ...
 * @param instance_index range audio instance index
 */
ZEGOEXP_API zego_error EXP_CALL zego_express_range_audio_set_team_id(const char * team_id, enum zego_range_audio_instance_index instance_index);
 ...
 * @param instance_index range audio instance index
 */
ZEGOEXP_API zego_error EXP_CALL zego_express_range_audio_mute_user(const char * userid, bool mute, enum zego_range_audio_instance_index instance_index);
 ...
 */
typedef void(*zego_on_range_audio_microphone_state_update)(enum zego_range_audio_microphone_state state, zego_error error_code, enum zego_range_audio_instance_index instance_index, void * user_context);

ZEGOEXP_API void EXP_CALL zego_register_range_audio_microphone_state_update_callback(zego_on_range_audio_microphone_state_update callback_func, void * user_context);
