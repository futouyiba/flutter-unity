 ...
 */
ZEGOEXP_API zego_error EXP_CALL zego_express_destroy_real_time_sequential_data_manager(int instance_index);
 ...
 */
ZEGOEXP_API zego_error EXP_CALL zego_express_real_time_sequential_data_start_broadcasting(const char * stream_id, int instance_index);
 ...
 * @param instance_index The real time sequential data manager instance index.
 */
ZEGOEXP_API zego_error EXP_CALL zego_express_real_time_sequential_data_stop_broadcasting(const char * stream_id, int instance_index);
 ...
 * @param instance_index The real time sequential data manager instance index.
 */
ZEGOEXP_API zego_seq EXP_CALL zego_express_send_real_time_sequential_data(const unsigned char* data, unsigned int data_length, const char * stream_id, int instance_index);
 ...
 * @param instance_index The real time sequential data manager instance index.
 */
ZEGOEXP_API zego_error EXP_CALL zego_express_real_time_sequential_data_start_subscribing(const char * stream_id, int instance_index);
 ...
 * @param instance_index The real time sequential data manager instance index.
 */
ZEGOEXP_API zego_error EXP_CALL zego_express_real_time_sequential_data_stop_subscribing(const char * stream_id, int instance_index);
 ...
 */
typedef void(*zego_on_receive_real_time_sequential_data)(int manager, const unsigned char* data, unsigned int data_length, const char * stream_id, void * user_context);

ZEGOEXP_API void EXP_CALL zego_register_receive_real_time_sequential_data_callback(zego_on_receive_real_time_sequential_data callback_func, void * user_context);
 ...
 * @param user_context Context of user.
 */
typedef void(*zego_on_real_time_sequential_data_sent)(zego_error error_code, int instance_index, zego_seq seq, void * user_context);

ZEGOEXP_API void EXP_CALL zego_register_real_time_sequential_data_sent_callback(zego_on_real_time_sequential_data_sent callback_func, void * user_context);
