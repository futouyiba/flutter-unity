...
namespace ZEGO {
    namespace EXPRESS {
        ...
        public:
             ...
             */
            virtual void setDummyCaptureImagePath(const std::string& filePath, ZegoPublishChannel channel = ZEGO_PUBLISH_CHANNEL_MAIN) = 0;
             ...
             */
            virtual void loginRoom(const std::string& roomID, ZegoUser user, ZegoRoomConfig config, ZegoRoomLoginCallback callback = nullptr) = 0;
             ...
             * @param callback The callback of this logout room result, if you need detailed room status, please pay attention to the [onRoomStateChanged] callback.. Required: No. Default value: nullptr.
             */
            virtual void logoutRoom(const std::string& roomID, ZegoRoomLogoutCallback callback = nullptr) = 0;
             ...
             * @param channel Publish stream channel.
             */
            virtual void startPublishingStream(const std::string& streamID, ZegoPublisherConfig config, ZegoPublishChannel channel = ZEGO_PUBLISH_CHANNEL_MAIN) = 0;
             ...
             * @param channel Publish stream channel
             */
            virtual void setStreamAlignmentProperty(int alignment, ZegoPublishChannel channel = ZEGO_PUBLISH_CHANNEL_MAIN) = 0;
             ...
             * @param channel Publish stream channel.
             */
            virtual void setMinVideoBitrateForTrafficControl(int bitrate, ZegoTrafficControlMinVideoBitrateMode mode, ZegoPublishChannel channel = ZEGO_PUBLISH_CHANNEL_MAIN) = 0;
             ...
             * @param channel Publish stream channel.
             */
            virtual void setMinVideoFpsForTrafficControl(int fps, ZegoPublishChannel channel = ZEGO_PUBLISH_CHANNEL_MAIN) = 0;
             ...
             * @param channel Publish stream channel.
             */
            virtual void setMinVideoResolutionForTrafficControl(int width, int height, ZegoPublishChannel channel = ZEGO_PUBLISH_CHANNEL_MAIN) = 0;
             ...
             * @param channel Publish stream channel.
             */
            virtual void sendSEISyncWithCustomVideo(const unsigned char* data, unsigned int dataLength, unsigned long long timeStampNs, ZegoPublishChannel channel = ZEGO_PUBLISH_CHANNEL_MAIN) = 0;
             ...
             * @param channel Publish stream channel.
             */
            virtual void sendAudioSideInfo(const unsigned char* data, unsigned int dataLength, double timeStampMs, ZegoPublishChannel channel = ZEGO_PUBLISH_CHANNEL_MAIN) = 0;
             ...
             */
            virtual void setPlayStreamVideoType(const std::string& streamID, ZegoVideoStreamType streamType) = 0;
             ...
             * @param channel Publishing stream channel
             */
            virtual void setCameraFocusMode(ZegoCameraFocusMode mode, ZegoPublishChannel channel = ZEGO_PUBLISH_CHANNEL_MAIN) = 0;
#endif
             ...
             * @param channel Publishing stream channel
             */
            virtual void setCameraFocusPointInPreview(float x, float y, ZegoPublishChannel channel = ZEGO_PUBLISH_CHANNEL_MAIN) = 0;
#endif
             ...
             * @param channel Publishing stream channel
             */
            virtual void setCameraExposureMode(ZegoCameraExposureMode mode, ZegoPublishChannel channel = ZEGO_PUBLISH_CHANNEL_MAIN) = 0;
#endif
             ...
             * @param channel Publishing stream channel
             */
            virtual void setCameraExposurePointInPreview(float x, float y, ZegoPublishChannel channel = ZEGO_PUBLISH_CHANNEL_MAIN) = 0;
#endif
             ...
             * @param channel Publishing stream channel
             */
            virtual void setCameraExposureCompensation(float value, ZegoPublishChannel channel = ZEGO_PUBLISH_CHANNEL_MAIN) = 0;
#endif
             ...
             */
            virtual void startAudioVADStableStateMonitor(ZegoAudioVADStableStateMonitorType type, int millisecond) = 0;
             ...
             * @param streamID Stream ID.
             */
            virtual void enablePlayStreamVirtualStereo(bool enable, int angle, const std::string& streamID) = 0;
             ...
             */
            virtual IZegoRealTimeSequentialDataManager* createRealTimeSequentialDataManager(const std::string& roomID) = 0;
             ...
             */
            virtual void destroyRealTimeSequentialDataManager(IZegoRealTimeSequentialDataManager*& manager) = 0;
             ...
             */
            virtual void startNetworkSpeedTest(ZegoNetworkSpeedTestConfig config, unsigned int interval = 3000) = 0;
             ...
             * @param channel Publishing stream channel
             */
            virtual void setCustomVideoCaptureDeviceState(bool isEnable, ZegoRemoteDeviceState state, ZegoPublishChannel channel = ZEGO_PUBLISH_CHANNEL_MAIN) = 0;
             ...
             * @param channel Publish channel
             */
            virtual void setCustomVideoCaptureRegionOfInterest(std::vector<ZegoRoiRect> rectList, ZegoPublishChannel channel = ZEGO_PUBLISH_CHANNEL_MAIN) = 0;
             ...
             */
            virtual void enableCustomVideoProcessing(bool enable, ZegoCustomVideoProcessConfig* config, ZegoPublishChannel channel = ZEGO_PUBLISH_CHANNEL_MAIN) = 0;
             ...
             */
            virtual void setCustomVideoProcessHandler(std::shared_ptr<IZegoCustomVideoProcessHandler> handler) = 0;
             ...
             * @param channel Publishing stream channel.Required: No.Default value: Main publish channel.
             */
            virtual void sendCustomVideoProcessedRawData(const unsigned char** data, unsigned int* dataLength, ZegoVideoFrameParam params, unsigned long long referenceTimeMillisecond, ZegoPublishChannel channel = ZEGO_PUBLISH_CHANNEL_MAIN) = 0;
             ...
             * @param channel Publishing stream channel.
             */
            virtual void sendCustomVideoProcessedCVPixelBuffer(void* buffer, unsigned long long timestamp, ZegoPublishChannel channel = ZEGO_PUBLISH_CHANNEL_MAIN) = 0;
             ...
             * @param config Custom audio processing configuration.
             */
            virtual void enableCustomAudioCaptureProcessingAfterHeadphoneMonitor(bool enable, ZegoCustomAudioProcessConfig* config) = 0;
             ...
             * @param config Custom audio processing configuration.
             */
            virtual void enableCustomAudioPlaybackProcessing(bool enable, ZegoCustomAudioProcessConfig* config) = 0;
        ...
        public:
             ...
             */
            virtual void setEventHandler(std::shared_ptr<IZegoRealTimeSequentialDataEventHandler> handler) = 0;
             ...
             */
            virtual void sendRealTimeSequentialData(const unsigned char* data, unsigned int dataLength, const std::string& streamID, ZegoRealTimeSequentialDataSentCallback callback) = 0;
        ...
        public:
             ...
             */
            virtual void updateSelfPosition(float position[3], float axisForward[3], float axisRight[3], float axisUp[3]) = 0;
        ...
        public:
             ...
             */
            virtual void initCopyrightedMusic(ZegoCopyrightedMusicConfig config, ZegoCopyrightedMusicInitCallback callback) = 0;
             ...
             */
            virtual void sendExtendedRequest(const std::string& command, const std::string& params, ZegoCopyrightedMusicSendExtendedRequestCallback callback) = 0;
             ...
             */
            virtual void getLrcLyric(const std::string& songID, ZegoCopyrightedMusicGetLrcLyricCallback callback) = 0;
             ...
             * @param callback get lyrics result.
             */
            virtual void getKrcLyricByToken(const std::string& krcToken, ZegoCopyrightedMusicGetKrcLyricByTokenCallback callback) = 0;
             ...
             */
            virtual void requestSong(ZegoCopyrightedMusicRequestConfig config, ZegoCopyrightedMusicRequestSongCallback callback) = 0;
             ...
             */
            virtual void requestAccompaniment(ZegoCopyrightedMusicRequestConfig config, ZegoCopyrightedMusicRequestAccompanimentCallback callback) = 0;
             ...
             */
            virtual void requestAccompanimentClip(ZegoCopyrightedMusicRequestConfig config, ZegoCopyrightedMusicRequestAccompanimentClipCallback callback) = 0;
             ...
             */
            virtual void getMusicByToken(const std::string& shareToken, ZegoCopyrightedMusicGetMusicByTokenCallback callback) = 0;
             ...
             */
            virtual void download(const std::string& resourceID, ZegoCopyrightedMusicDownloadCallback callback) = 0;
             ...
             */
            virtual void getStandardPitch(const std::string& resourceID, ZegoCopyrightedMusicGetStandardPitchCallback callback) = 0;
        ...
        public:
             ...
             * @param callback Notification of resource loading results
             */
            virtual void loadResourceWithPosition(const std::string& path, unsigned long long startPosition, ZegoMediaPlayerLoadResourceCallback callback) = 0;
             ...
             * @param callback Notification of resource loading results.
             */
            virtual void loadResourceFromMediaData(unsigned char* media_data, int media_data_length, unsigned long long start_position, ZegoMediaPlayerLoadResourceCallback callback) = 0;
             ...
             * @param callback Notification of resource loading results
             */
            virtual void loadCopyrightedMusicResourceWithPosition(const std::string& resourceID, unsigned long long startPosition, ZegoMediaPlayerLoadResourceCallback callback) = 0;
        ...
        public:
             ...
             * When to call: After calling the [createMediaDataPublisher] function to create a media data publisher.
             */
            virtual void setMediaDataPublisherEventHandler(std::shared_ptr<IZegoMediaDataPublisherEventHandler> handler) = 0;
