 ...
 */
ZEGOEXP_API zego_error EXP_CALL zego_express_engine_init_with_profile(struct zego_engine_profile profile);
 ...
 */
ZEGOEXP_API zego_error EXP_CALL zego_express_set_dummy_capture_image_path(const char * file_path, enum zego_publish_channel channel);
...
ZEGOEXP_API void EXP_CALL zego_register_network_time_synchronized_callback(zego_on_network_time_synchronized callback_func, void * user_context);
...
ZEGOEXP_API void EXP_CALL zego_register_recv_experimental_api_callback(zego_on_recv_experimental_api callback_func, void * user_context);
 ...
 * @param user_context Context of user.
 */
typedef void(*zego_on_network_quality)(const char * userid, enum zego_stream_quality_level upstream_quality, enum zego_stream_quality_level downstream_quality, void * user_context);

ZEGOEXP_API void EXP_CALL zego_register_network_quality_callback(zego_on_network_quality callback_func, void * user_context);
