 ...
 * TODO
 */
ZEGOEXP_API zego_error EXP_CALL zego_express_media_player_load_resource_from_media_data(unsigned char* media_data, int media_data_length, long start_position, enum zego_media_player_instance_index instance_index);
 ...
 */
ZEGOEXP_API zego_error EXP_CALL zego_express_media_player_load_resource_with_position(const char * path, long start_position, enum zego_media_player_instance_index instance_index);
 ...
 * @param start_position The progress at which the playback started.
 */
ZEGOEXP_API zego_error EXP_CALL zego_express_media_player_load_copyrighted_music_resource_with_position(const char * resource_id, long start_position, enum zego_media_player_instance_index instance_index);
 ...
 */
ZEGOEXP_API zego_error EXP_CALL zego_express_media_player_set_play_loop_count(int count, enum zego_media_player_instance_index instance_index);
 ...
 */
ZEGOEXP_API zego_error EXP_CALL zego_express_media_player_set_play_speed(float speed, enum zego_media_player_instance_index instance_index);
 ...
 */
ZEGOEXP_API zego_error EXP_CALL zego_express_media_player_enable_sound_level_monitor(bool enable, unsigned int millisecond, enum zego_media_player_instance_index instance_index);
 ...
 */
ZEGOEXP_API zego_error EXP_CALL zego_express_media_player_enable_frequency_spectrum_monitor(bool enable, unsigned int millisecond, enum zego_media_player_instance_index instance_index);
 ...
 * @param user_context Context of user.
 */
typedef void(*zego_on_media_player_sound_level_update)(float sound_level, enum zego_media_player_instance_index instance_index, void * user_context);

ZEGOEXP_API void EXP_CALL zego_register_media_player_sound_level_update_callback(zego_on_media_player_sound_level_update callback_func, void * user_context);
 ...
 * @param user_context Context of user.
 */
typedef void(*zego_on_media_player_frequency_spectrum_update)(float* spectrum_list, unsigned int spectrum_count, enum zego_media_player_instance_index instance_index, void * user_context);

ZEGOEXP_API void EXP_CALL zego_register_media_player_frequency_spectrum_update_callback(zego_on_media_player_frequency_spectrum_update callback_func, void * user_context);
 ...
 * @param user_context Context of user.
 */
typedef void(*zego_on_media_player_video_frame)(const unsigned char** data, unsigned int* data_length, const struct zego_video_frame_param param, const char* extra_info, enum zego_media_player_instance_index instance_index, void * user_context);
