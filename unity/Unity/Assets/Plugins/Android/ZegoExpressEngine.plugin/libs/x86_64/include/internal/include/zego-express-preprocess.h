 ...
 */
ZEGOEXP_API zego_error EXP_CALL zego_express_set_effects_beauty_param(struct zego_effects_beauty_param param);
 ...
 */
ZEGOEXP_API zego_error EXP_CALL zego_express_enable_play_stream_virtual_stereo(bool enable, int angle, const char * stream_id);
 ...
 */
ZEGOEXP_API zego_error EXP_CALL zego_express_set_electronic_effects(bool enable, enum zego_electronic_effects_mode mode, int tonal);
