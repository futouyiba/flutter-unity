 ...
 * @param channel Publishing stream channel
 */
ZEGOEXP_API zego_error EXP_CALL zego_express_set_camera_focus_mode(enum zego_camera_focus_mode mode, enum zego_publish_channel channel);
 ...
 * @param channel Publishing stream channel
 */
ZEGOEXP_API zego_error EXP_CALL zego_express_set_camera_focus_point_in_preview(float x, float y, enum zego_publish_channel channel);
 ...
 * @param channel Publishing stream channel
 */
ZEGOEXP_API zego_error EXP_CALL zego_express_set_camera_exposure_mode(enum zego_camera_exposure_mode mode, enum zego_publish_channel channel);
 ...
 * @param channel Publishing stream channel
 */
ZEGOEXP_API zego_error EXP_CALL zego_express_set_camera_exposure_point_in_preview(float x, float y, enum zego_publish_channel channel);
 ...
 * @param channel Publishing stream channel
 */
ZEGOEXP_API zego_error EXP_CALL zego_express_set_camera_exposure_compensation(float value, enum zego_publish_channel channel);
 ...
 */
ZEGOEXP_API zego_error EXP_CALL zego_express_start_sound_level_monitor_with_config(struct zego_sound_level_config config);
 ...
 */
ZEGOEXP_API zego_error EXP_CALL zego_express_start_audio_vad_stable_state_monitor(enum zego_audio_vad_stable_state_monitor_type type, int millisecond);
 ...
 * @param type audio VAD monitor type.
 */
ZEGOEXP_API zego_error EXP_CALL zego_express_stop_audio_vad_stable_state_monitor(enum zego_audio_vad_stable_state_monitor_type type);
 ...
 * @param user_context Context of user.
 */
typedef void(*zego_on_captured_sound_level_info_update)(const struct zego_sound_level_info* sound_level_info, void * user_context);

ZEGOEXP_API void EXP_CALL zego_register_captured_sound_level_info_update_callback(zego_on_captured_sound_level_info_update callback_func, void * user_context);
 ...
 * @param user_context Context of user.
 */
typedef void(*zego_on_remote_sound_level_info_update)(const struct zego_sound_level_info* sound_level_info, unsigned int info_count, void * user_context);

ZEGOEXP_API void EXP_CALL zego_register_remote_sound_level_info_update_callback(zego_on_remote_sound_level_info_update callback_func, void * user_context);
 ...
 * @param user_context Context of user.
 */
typedef void(*zego_on_local_device_exception_occurred)(enum zego_device_exception_type exception_type, enum zego_device_type device_type, const char * device_id, void * user_context);

ZEGOEXP_API void EXP_CALL zego_register_local_device_exception_occurred_callback(zego_on_local_device_exception_occurred callback_func, void * user_context);
 ...
 * @param user_context Context of user.
 */
typedef void(*zego_on_remote_speaker_state_update)(const char * stream_id, enum zego_remote_device_state state, void * user_context);

ZEGOEXP_API void EXP_CALL zego_register_remote_speaker_state_update_callback(zego_on_remote_speaker_state_update callback_func, void * user_context);
 ...
 * @param user_context Context of user.
 */
typedef void(*zego_on_audio_vad_state_update)(enum zego_audio_vad_stable_state_monitor_type type, enum zego_audio_vad_type state, void * user_context);

ZEGOEXP_API void EXP_CALL zego_register_audio_vad_state_update_callback(zego_on_audio_vad_state_update callback_func, void * user_context);
 ...
 */
ZEGOEXP_API struct zego_device_info EXP_CALL zego_express_get_current_audio_device(enum zego_audio_device_type device_type);
 ...
 * @param user_context Context of user.
 */
typedef void(*zego_on_device_error)(zego_error error_code, const char * device_id, const char * device_name, void * user_context);
