 ...
 */
ZEGOEXP_API zego_seq EXP_CALL zego_express_copyrighted_music_init(struct zego_copyrighted_music_config config);
 ...
 */
ZEGOEXP_API zego_seq EXP_CALL zego_express_copyrighted_music_send_extended_request(const char * command, const char * params);
 ...
 */
ZEGOEXP_API zego_seq EXP_CALL zego_express_copyrighted_music_get_krc_lyric_by_token(const char * krc_token);
 ...
 */
ZEGOEXP_API zego_seq EXP_CALL zego_express_copyrighted_music_request_song(struct zego_copyrighted_music_request_config config);
 ...
 * @param config request configuration.
 */
ZEGOEXP_API zego_seq EXP_CALL zego_express_copyrighted_music_request_accompaniment(struct zego_copyrighted_music_request_config config);
 ...
 * @param config request configuration.
 */
ZEGOEXP_API zego_seq EXP_CALL zego_express_copyrighted_music_request_accompaniment_clip(struct zego_copyrighted_music_request_config config);
 ...
 */
ZEGOEXP_API zego_seq EXP_CALL zego_express_copyrighted_music_get_music_by_token(const char * share_token);
 ...
 */
ZEGOEXP_API bool EXP_CALL zego_express_copyrighted_music_query_cache(const char * song_id, enum zego_copyrighted_music_type type);
 ...
 * @param resource_id the resource ID corresponding to the song or accompaniment.
 */
ZEGOEXP_API unsigned long long EXP_CALL zego_express_copyrighted_music_get_duration(const char * resource_id);
 ...
 */
ZEGOEXP_API int EXP_CALL zego_express_copyrighted_music_start_score(const char * resource_id, int pitch_value_interval);
 ...
 * @param resource_id the resource ID corresponding to the song or accompaniment.
 */
ZEGOEXP_API zego_seq EXP_CALL zego_express_copyrighted_music_get_standard_pitch(const char * resource_id);
 ...
 */
typedef void(*zego_on_copyrighted_music_download_progress_update)(zego_seq seq, const char * resource_id, float progress_rate, void * user_context);

ZEGOEXP_API void EXP_CALL zego_register_copyrighted_music_download_progress_update_callback(zego_on_copyrighted_music_download_progress_update callback_func, void * user_context);
 ...
 * @param user_context Context of user.
 */
typedef void(*zego_on_copyrighted_music_current_pitch_value_update)(const char * resource_id, int current_duration, int pitch_value, void * user_context);

ZEGOEXP_API void EXP_CALL zego_register_copyrighted_music_current_pitch_value_update_callback(zego_on_copyrighted_music_current_pitch_value_update callback_func, void * user_context);
 ...
 * @param user_context Context of user.
 */
typedef void(*zego_on_copyrighted_music_init)(zego_seq seq, zego_error error_code, void * user_context);

ZEGOEXP_API void EXP_CALL zego_register_copyrighted_music_init_callback(zego_on_copyrighted_music_init callback_func, void * user_context);
 ...
 * @param user_context Context of user.
 */
typedef void(*zego_on_copyrighted_music_send_extended_request)(zego_seq seq, zego_error error_code, const char * command, const char * result, void * user_context);

ZEGOEXP_API void EXP_CALL zego_register_copyrighted_music_send_extended_request_callback(zego_on_copyrighted_music_send_extended_request callback_func, void * user_context);
 ...
 * @param user_context Context of user.
 */
typedef void(*zego_on_copyrighted_music_get_lrc_lyric)(zego_seq seq, zego_error error_code, const char * lyrics, void * user_context);

ZEGOEXP_API void EXP_CALL zego_register_copyrighted_music_get_lrc_lyric_callback(zego_on_copyrighted_music_get_lrc_lyric callback_func, void * user_context);
 ...
 * @param user_context Context of user.
 */
typedef void(*zego_on_copyrighted_music_get_krc_lyric_by_token)(zego_seq seq, zego_error error_code, const char * lyrics, void * user_context);

ZEGOEXP_API void EXP_CALL zego_register_copyrighted_music_get_krc_lyric_by_token_callback(zego_on_copyrighted_music_get_krc_lyric_by_token callback_func, void * user_context);
 ...
 * @param user_context Context of user.
 */
typedef void(*zego_on_copyrighted_music_request_song)(zego_seq seq, zego_error error_code, const char * resource, void * user_context);

ZEGOEXP_API void EXP_CALL zego_register_copyrighted_music_request_song_callback(zego_on_copyrighted_music_request_song callback_func, void * user_context);
 ...
 * @param user_context Context of user.
 */
typedef void(*zego_on_copyrighted_music_request_accompaniment)(zego_seq seq, zego_error error_code, const char * resource, void * user_context);

ZEGOEXP_API void EXP_CALL zego_register_copyrighted_music_request_accompaniment_callback(zego_on_copyrighted_music_request_accompaniment callback_func, void * user_context);
 ...
 * @param user_context Context of user.
 */
typedef void(*zego_on_copyrighted_music_request_accompaniment_clip)(zego_seq seq, zego_error error_code, const char * resource, void * user_context);

ZEGOEXP_API void EXP_CALL zego_register_copyrighted_music_request_accompaniment_clip_callback(zego_on_copyrighted_music_request_accompaniment_clip callback_func, void * user_context);
 ...
 * @param user_context Context of user.
 */
typedef void(*zego_on_copyrighted_music_get_music_by_token)(zego_seq seq, zego_error error_code, const char * resource, void * user_context);

ZEGOEXP_API void EXP_CALL zego_register_copyrighted_music_get_music_by_token_callback(zego_on_copyrighted_music_get_music_by_token callback_func, void * user_context);
 ...
 * @param user_context Context of user.
 */
typedef void(*zego_on_copyrighted_music_download)(zego_seq seq, zego_error error_code, void * user_context);

ZEGOEXP_API void EXP_CALL zego_register_copyrighted_music_download_callback(zego_on_copyrighted_music_download callback_func, void * user_context);
 ...
 * @param user_context Context of user.
 */
typedef void(*zego_on_copyrighted_music_get_standard_pitch)(zego_seq seq, zego_error error_code, const char * pitch, void * user_context);

ZEGOEXP_API void EXP_CALL zego_register_copyrighted_music_get_standard_pitch_callback(zego_on_copyrighted_music_get_standard_pitch callback_func, void * user_context);
