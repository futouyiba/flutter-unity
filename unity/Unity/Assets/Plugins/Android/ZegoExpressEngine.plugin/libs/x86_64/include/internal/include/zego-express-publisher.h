 ...
 * @param channel Publish stream channel.
 */
ZEGOEXP_API zego_error EXP_CALL zego_express_start_publishing_stream_with_config(const char * stream_id, struct zego_publisher_config config, enum zego_publish_channel channel);
 ...
 * @param channel Publish stream channel
 */
ZEGOEXP_API zego_error EXP_CALL zego_express_set_stream_alignment_property(int alignment, enum zego_publish_channel channel);
 ...
 * @param channel Publish stream channel.
 */
ZEGOEXP_API zego_error EXP_CALL zego_express_set_min_video_fps_for_traffic_control_by_channel(int fps, enum zego_publish_channel channel);
 ...
 * @param channel Publish stream channel.
 */
ZEGOEXP_API zego_error EXP_CALL zego_express_set_min_video_resolution_for_traffic_control_by_channel(int width, int height, enum zego_publish_channel channel);
 ...
 * @param channel Publish stream channel.
 */
ZEGOEXP_API zego_error EXP_CALL zego_express_send_sei_sync_with_custom_video(const unsigned char* data, unsigned int data_length, unsigned long long timestamp_ns, enum zego_publish_channel channel);
 ...
 * @param channel Publish stream channel.
 */
ZEGOEXP_API zego_error EXP_CALL zego_express_send_audio_side_info(const unsigned char* data, unsigned int data_length, double timestamp_ms, enum zego_publish_channel channel);
 ...
 */
ZEGOEXP_API bool EXP_CALL zego_express_is_video_encoder_supported(enum zego_video_codec_id codec_id);
 ...
 * @param user_context Context of user.
 */
typedef void(*zego_on_publisher_video_encoder_changed)(enum zego_video_codec_id from_codec_id, enum zego_video_codec_id to_codec_id, enum zego_publish_channel channel, void * user_context);

ZEGOEXP_API void EXP_CALL zego_register_publisher_video_encoder_changed_callback(zego_on_publisher_video_encoder_changed callback_func, void * user_context);
 ...
 * @param user_context Context of user.
 */
typedef void(*zego_on_publisher_stream_event)(enum zego_stream_event event_id, const char * stream_id, const char * extra_info, void * user_context);

ZEGOEXP_API void EXP_CALL zego_register_publisher_stream_event_callback(zego_on_publisher_stream_event callback_func, void * user_context);
