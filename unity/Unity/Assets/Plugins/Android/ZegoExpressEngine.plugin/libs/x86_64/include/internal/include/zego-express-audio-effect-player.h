 ...
 * @param instance_index audio effect instance index.
 */
ZEGOEXP_API zego_error EXP_CALL zego_express_audio_effect_player_seek_to(unsigned int audio_effect_id, unsigned long long millisecond, enum zego_audio_effect_player_instance_index instance_index);
 ...
 * @param instance_index audio effect instance index.
 */
ZEGOEXP_API zego_error EXP_CALL zego_express_audio_effect_player_set_play_speed(unsigned int audio_effect_id, float speed, enum zego_audio_effect_player_instance_index instance_index);
