...
namespace ZEGO {
    namespace EXPRESS {
        ...
        public:
             ...
             * @param channel Publishing stream channel.If you only publish one audio and video stream, you can ignore this parameter.
             */
            virtual void onPublisherVideoEncoderChanged(ZegoVideoCodecID /*fromCodecID*/, ZegoVideoCodecID /*toCodecID*/, ZegoPublishChannel /*channel*/) {
             ...
             */
            virtual void onPublisherStreamEvent(ZegoStreamEvent /*eventID*/, const std::string& /*streamID*/, const std::string& /*extraInfo*/) {
             ...
             */
            virtual void onPlayerRecvAudioSideInfo(const std::string& /*streamID*/, const unsigned char* /*data*/, unsigned int /*dataLength*/) {
             ...
             * @param streamID Stream ID.
             */
            virtual void onPlayerLowFpsWarning(ZegoVideoCodecID /*codecID*/, const std::string& /*streamID*/) {
             ...
             * @param extraInfo extra info. it is in JSON format. Included information includes "url" for address, "streamProtocol" for stream protocol, including rtmp, flv, avertp, hls, webrtc, etc. "netProtocol" for network protocol, including tcp, udp, quic, "resourceType" for resource type , including cdn, rtc, l3.
             */
            virtual void onPlayerStreamEvent(ZegoStreamEvent /*eventID*/, const std::string& /*streamID*/, const std::string& /*extraInfo*/) {
             ...
             */
            virtual void onAutoMixerSoundLevelUpdate(const std::unordered_map<std::string, float>& /*soundLevels*/) {
             ...
             */
            virtual void onRemoteSoundLevelInfoUpdate(const std::unordered_map<std::string, ZegoSoundLevelInfo>& /*soundLevelInfos*/) {
             ...
             */
            virtual void onRemoteSpeakerStateUpdate(const std::string& /*streamID*/, ZegoRemoteDeviceState /*state*/) {
             ...
             */
            virtual void onAudioVADStateUpdate(ZegoAudioVADStableStateMonitorType /*type*/, ZegoAudioVADType /*state*/) {
             ...
             */
            virtual void onNetworkQuality(const std::string& /*userID*/, ZegoStreamQualityLevel /*upstreamQuality*/, ZegoStreamQualityLevel /*downstreamQuality*/) {
             ...
             */
            ZEGO_DEPRECATED
            virtual void onDeviceError(int /*errorCode*/, const std::string& /*deviceID*/, const std::string& /*deviceName*/) {
        ...
        public:
             ...
             */
            virtual void onReceiveRealTimeSequentialData(IZegoRealTimeSequentialDataManager* /*manager*/, const unsigned char* /*data*/, unsigned int /*dataLength*/, const std::string& /*streamID*/) {
        ...
        public:
             ...
             */
            virtual void onMediaPlayerSoundLevelUpdate(IZegoMediaPlayer* /*mediaPlayer*/, float /*soundLevel*/) {
             ...
             */
            virtual void onMediaPlayerFrequencySpectrumUpdate(IZegoMediaPlayer* /*mediaPlayer*/, const ZegoAudioSpectrum& /*spectrumList*/) {
        ...
        public:
             ...
             */
            virtual void onVideoFrame(IZegoMediaPlayer* /*mediaPlayer*/, const unsigned char** /*data*/, unsigned int* /*dataLength*/, ZegoVideoFrameParam /*param*/, const char* /*extraInfo*/) {
        ...
        public:
             ...
             */
            virtual void onMediaDataPublisherFileOpen(IZegoMediaDataPublisher * /*mediaDataPublisher*/, const std::string& /*path*/) {
             ...
             * @param path Path of currently open file
             */
            virtual void onMediaDataPublisherFileClose(IZegoMediaDataPublisher * /*mediaDataPublisher*/, int /*errorCode*/, const std::string& /*path*/) {
             ...
             * @param path Path of currently open file
             */
            virtual void onMediaDataPublisherFileDataBegin(IZegoMediaDataPublisher * /*mediaDataPublisher*/, const std::string& /*path*/) {
        ...
        public:
             ...
             */
            virtual void onProcessCapturedAudioData(unsigned char* /*data*/, unsigned int /*dataLength*/, ZegoAudioFrameParam* /*param*/, double /*timestamp*/) {
             ...
             * @param timestamp The audio frame timestamp, starting from 0 when capture is started, the unit is milliseconds.
             */
            virtual void onProcessCapturedAudioDataAfterUsedHeadphoneMonitor(unsigned char* /*data*/, unsigned int /*dataLength*/, ZegoAudioFrameParam* /*param*/, double /*timestamp*/) {
             ...
             * @param timestamp The audio frame timestamp, starting from 0 when capture is started, the unit is milliseconds.
             */
            virtual void onProcessRemoteAudioData(unsigned char* /*data*/, unsigned int /*dataLength*/, ZegoAudioFrameParam* /*param*/, const std::string& /*streamID*/, double /*timestamp*/) {
             ...
             */
            virtual void onProcessPlaybackAudioData(unsigned char* /*data*/, unsigned int /*dataLength*/, ZegoAudioFrameParam* /*param*/, double /*timestamp*/) {
             ...
             */
            ZEGO_DEPRECATED
            virtual void onProcessPlaybackAudioData(unsigned char* /*data*/, unsigned int /*dataLength*/, ZegoAudioFrameParam* /*param*/) {
        ...
        public:
             ...
             */
            virtual void onDownloadProgressUpdate(IZegoCopyrightedMusic* /*copyrightedMusic*/, const std::string& /*resourceID*/, float /*progressRate*/) {
             ...
             */
            virtual void onCurrentPitchValueUpdate(IZegoCopyrightedMusic* /*copyrightedMusic*/, const std::string& /*resourceID*/, int /*currentDuration*/, int /*pitchValue*/) {
