 ...
 */
ZEGOEXP_API zego_error EXP_CALL zego_express_set_play_stream_cross_app_info(const char * stream_id, struct zego_cross_app_info info);
 ...
 */
ZEGOEXP_API bool EXP_CALL zego_express_is_video_decoder_supported(enum zego_video_codec_id codec_id);
 ...
 */
ZEGOEXP_API zego_error EXP_CALL zego_express_set_play_streams_alignment_property(enum zego_stream_alignment_mode mode);
 ...
 * @param user_context Context of user.
 */
typedef void(*zego_on_player_recv_audio_side_info)(const char * stream_id, const unsigned char* data, unsigned int data_length, void * user_context);

ZEGOEXP_API void EXP_CALL zego_register_player_recv_audio_side_info_callback(zego_on_player_recv_audio_side_info callback_func, void * user_context);
 ...
 * @param user_context Context of user.
 */
typedef void(*zego_on_player_low_fps_warning)(enum zego_video_codec_id codec_id, const char * stream_id, void * user_context);

ZEGOEXP_API void EXP_CALL zego_register_player_low_fps_warning_callback(zego_on_player_low_fps_warning callback_func, void * user_context);
 ...
 * @param user_context Context of user.
 */
typedef void(*zego_on_player_stream_event)(enum zego_stream_event event_id, const char * stream_id, const char * extra_info, void * user_context);

ZEGOEXP_API void EXP_CALL zego_register_player_stream_event_callback(zego_on_player_stream_event callback_func, void * user_context);
