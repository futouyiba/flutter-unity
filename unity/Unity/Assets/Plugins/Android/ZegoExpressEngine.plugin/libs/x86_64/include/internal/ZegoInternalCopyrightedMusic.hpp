...
namespace ZEGO
{
    namespace EXPRESS
    {
        ...
        {
        public:
            ZegoExpressCopyrightedMusicImp(int index) : instanceIndex(index){}
            ...
            void initCopyrightedMusic(ZegoCopyrightedMusicConfig config, ZegoCopyrightedMusicInitCallback callback) override
            {
                ...
                ZegoStrncpy(_config.user.user_name, config.user.userName.c_str(), ZEGO_EXPRESS_MAX_USERNAME_LEN);
            ...
            {
                oInternalOriginBridge->copyrightedMusicClearCache();
            }

            void sendExtendedRequest(const std::string& command, const std::string& params, ZegoCopyrightedMusicSendExtendedRequestCallback callback) override
            {
            ...
            void getLrcLyric(const std::string& songID, ZegoCopyrightedMusicGetLrcLyricCallback callback) override
            {
            ...
            void getKrcLyricByToken(const std::string& krcToken, ZegoCopyrightedMusicGetKrcLyricByTokenCallback callback) override
            {
            ...
            void requestSong(ZegoCopyrightedMusicRequestConfig config, ZegoCopyrightedMusicRequestSongCallback callback) override
            {
            ...
            void requestAccompaniment(ZegoCopyrightedMusicRequestConfig config, ZegoCopyrightedMusicRequestAccompanimentCallback callback) override
            {
                zego_copyrighted_music_request_config _config;
                memset(&_config.song_id, 0, sizeof(_config.song_id));
                ZegoStrncpy(_config.song_id, config.songID.c_str(), ZEGO_EXPRESS_MAX_COMMON_LEN);
            ...
            void requestAccompanimentClip(ZegoCopyrightedMusicRequestConfig config, ZegoCopyrightedMusicRequestAccompanimentClipCallback callback) override
            {
                zego_copyrighted_music_request_config _config;
                memset(&_config.song_id, 0, sizeof(_config.song_id));
                ZegoStrncpy(_config.song_id, config.songID.c_str(), ZEGO_EXPRESS_MAX_COMMON_LEN);
            ...
            void getMusicByToken(const std::string& songToken, ZegoCopyrightedMusicGetMusicByTokenCallback callback) override
            {
            ...
            void download(const std::string& resourceID, ZegoCopyrightedMusicDownloadCallback callback) override
            {
            ...
            bool queryCache(const std::string& songID, ZegoCopyrightedMusicType type) override
            {
                ...
                bool result = oInternalOriginBridge->copyrightedMusicQueryCache(_songID, (zego_copyrighted_music_type)type);
                return result;
            }
            ...
            unsigned long long getDuration(const std::string& resourceID) override
            {
                ...
                unsigned long long totalDuration = oInternalOriginBridge->copyrightedMusicGetDuration(_resourceID);
            ...
            int startScore(const std::string& resourceID, int pitchValueInterval) override
            {
                ...
                int ret = oInternalOriginBridge->copyrightedMusicStartScore(_resourceID, pitchValueInterval);
                return ret;
            }
            ...
            void getStandardPitch(const std::string& resourceID, ZegoCopyrightedMusicGetStandardPitchCallback callback) override
            {
                const char* _resourceID = resourceID.empty() ? nullptr : resourceID.c_str();
            ...
            void zego_on_copyrighted_music_download_progress_update(const char * resource_id, float progress_rate)
            {
                std::lock_guard<std::mutex> lock(copyrightedMusicEventMutex);
                if (eventHandler)
                {
            ...
            void zego_on_copyrighted_music_current_pitch_value_update(const char* resource_id, int current_duration, int pitch_value)
            {
                std::lock_guard<std::mutex> lock(copyrightedMusicEventMutex);
                if (eventHandler)
                {
                    ...
                    if (handlerInMain)
                    {
                        handlerInMain->onCurrentPitchValueUpdate(this, stdresource_id, current_duration, pitch_value);
                    }
                    ZEGO_SWITCH_THREAD_ING
                }
            }
            ...
            void zego_on_copyrighted_music_send_extended_request(zego_seq seq, zego_error error_code, const char * command, const char * result)
            {
                std::lock_guard<std::mutex> lock(copyrightedMusicEventMutex);
            ...
            void zego_on_copyrighted_music_get_lrc_lyric(zego_seq seq, zego_error error_code, const char * lyrics)
            {
                std::lock_guard<std::mutex> lock(copyrightedMusicEventMutex);
            ...
            void zego_on_copyrighted_music_get_krc_lyric_by_token(zego_seq seq, zego_error error_code, const char * lyrics)
            {
                std::lock_guard<std::mutex> lock(copyrightedMusicEventMutex);
            ...
            void zego_on_copyrighted_music_request_song(zego_seq seq, zego_error error_code, const char * resource_id)
            {
                std::lock_guard<std::mutex> lock(copyrightedMusicEventMutex);
            ...
            void zego_on_copyrighted_music_request_accompaniment(zego_seq seq, zego_error error_code, const char * resource_id)
            {
                std::lock_guard<std::mutex> lock(copyrightedMusicEventMutex);
            ...
            void zego_on_copyrighted_music_request_accompaniment_clip(zego_seq seq, zego_error error_code, const char* resource_id)
            {
                std::lock_guard<std::mutex> lock(copyrightedMusicEventMutex);
            ...
            void zego_on_copyrighted_music_get_music_by_token(zego_seq seq, zego_error error_code, const char * resource_id)
            {
                std::lock_guard<std::mutex> lock(copyrightedMusicEventMutex);
            ...
            void zego_on_copyrighted_music_get_standard_pitch(zego_seq seq, zego_error error_code, const char * pitch)
            {
                std::lock_guard<std::mutex> lock(copyrightedMusicEventMutex);
        ...
        private:
            ...
            std::unordered_map<zego_seq, ZegoCopyrightedMusicSendExtendedRequestCallback> sendExtendedRequestCallbacks;
            std::unordered_map<zego_seq, ZegoCopyrightedMusicGetLrcLyricCallback> getLrcLyricCallbacks;
            std::unordered_map<zego_seq, ZegoCopyrightedMusicGetKrcLyricByTokenCallback> getKrcLyricByTokenCallbacks;
            std::unordered_map<zego_seq, ZegoCopyrightedMusicRequestSongCallback> cmOrderSongCallbacks;
            std::unordered_map<zego_seq, ZegoCopyrightedMusicRequestAccompanimentCallback> orderAccompanimentCallbacks;
            std::unordered_map<zego_seq, ZegoCopyrightedMusicRequestAccompanimentClipCallback> orderAccompanimentClipCallbacks;
            std::unordered_map<zego_seq, ZegoCopyrightedMusicGetMusicByTokenCallback> getMusicByTokenCallbacks;
            std::unordered_map<zego_seq, ZegoCopyrightedMusicDownloadCallback> loadCallbacks;
            std::unordered_map<zego_seq, ZegoCopyrightedMusicGetStandardPitchCallback> getStandardPitchCallbacks;
        ...
        #define oCopyrightedMusicContainer ZegoSingleton<ZegoExpressCopyrightedMusicContainer>::CreateInstance()
    } // namespace EXPRESS
} // namespace ZEGO