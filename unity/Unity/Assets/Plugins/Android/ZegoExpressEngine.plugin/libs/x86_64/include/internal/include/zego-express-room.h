 ...
 * @param config Advanced room configuration.
 */
ZEGOEXP_API zego_seq EXP_CALL zego_express_login_room_with_callback(const char * room_id, struct zego_user user, struct zego_room_config * config);
 ...
 * @param user_context context of user
 */
typedef void(*zego_on_room_state_changed)(const char * room_id, enum zego_room_state_changed_reason reason, zego_error error_code, const char * extended_data, void * user_context);

ZEGOEXP_API void EXP_CALL zego_register_room_state_changed_callback(zego_on_room_state_changed callback_func, void * user_context);
 ...
 * @param user_context context of user
 */
typedef void(*zego_on_room_token_will_expire)(const char * room_id, int remain_time_in_second, void * user_context);

ZEGOEXP_API void EXP_CALL zego_register_room_token_will_expire_callback(zego_on_room_token_will_expire callback_func, void * user_context);
...
ZEGOEXP_API void EXP_CALL zego_register_room_login_result_callback(zego_on_room_login_result callback_func, void * user_context);
 ...
 * @param user_context Context of user.
 */
typedef void(*zego_on_room_logout_result)(zego_error error_code, const char * extended_data, const char * room_id, zego_seq seq, void * user_context);

ZEGOEXP_API void EXP_CALL zego_register_room_logout_result_callback(zego_on_room_logout_result callback_func, void * user_context);
