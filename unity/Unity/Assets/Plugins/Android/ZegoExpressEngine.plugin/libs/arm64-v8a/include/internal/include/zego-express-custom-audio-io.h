 ...
 * @param config Custom audio processing configuration.
 */
ZEGOEXP_API zego_error EXP_CALL zego_express_enable_custom_audio_capture_processing_after_headphone_monitor(bool enable, struct zego_custom_audio_process_config* config);
 ...
 * @param config Custom audio processing configuration.
 */
ZEGOEXP_API zego_error EXP_CALL zego_express_enable_custom_audio_playback_processing(bool enable, struct zego_custom_audio_process_config* config);
 ...
 * @param param The param of this PCM audio frame
 */
ZEGOEXP_API zego_error EXP_CALL zego_express_send_reference_audio_pcm_data(unsigned char * data, unsigned int data_length, struct zego_audio_frame_param param);
 ...
 */
typedef void(*zego_on_process_captured_audio_data)(unsigned char* data, unsigned int data_length, struct zego_audio_frame_param* param, double timestamp, void * user_context);
 ...
 * @param user_context Context of user.
 */
typedef void(*zego_on_process_captured_audio_data_after_used_headphone_monitor)(unsigned char* data, unsigned int data_length, struct zego_audio_frame_param* param, double timestamp, void * user_context);

ZEGOEXP_API void EXP_CALL zego_register_process_captured_audio_data_after_used_headphone_monitor_callback(zego_on_process_captured_audio_data_after_used_headphone_monitor callback_func, void * user_context);
 ...
 * @param user_context Context of user.
 */
typedef void(*zego_on_process_remote_audio_data)(unsigned char* data, unsigned int data_length, struct zego_audio_frame_param* param, const char * stream_id, double timestamp, void * user_context);
 ...
 * @param user_context Context of user.
 */
typedef void(*zego_on_process_playback_audio_data)(unsigned char* data, unsigned int data_length, struct zego_audio_frame_param* param, double timestamp, void * user_context);

ZEGOEXP_API void EXP_CALL zego_register_process_playback_audio_data_callback(zego_on_process_playback_audio_data callback_func, void * user_context);
