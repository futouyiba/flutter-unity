...
#define oInternalCallbackCenter ZegoSingleton<ZegoInternalCallbackCenter>::CreateInstance()
        ...
        public:
            ...
            {
                std::lock_guard<std::recursive_mutex> locker(oCopyrightedMusicContainer->copyrightedMusicMutex);
            ...
            void registerCallback()
            {
                ...
                oInternalOriginBridge->registerRoomTokenWillExpireCallback(ZegoVoidPtr(&ZegoInternalCallbackCenter::zego_on_room_token_will_expire), ZegoVoidPtr(this));
                oInternalOriginBridge->registerRoomLoginCallback(ZegoVoidPtr(&ZegoInternalCallbackCenter::zego_on_room_login_callback), ZegoVoidPtr(this));
                oInternalOriginBridge->registerRoomLogoutCallback(ZegoVoidPtr(&ZegoInternalCallbackCenter::zego_on_room_logout_callback), ZegoVoidPtr(this));
                oInternalOriginBridge->registerRoomStateChangedCallback(ZegoVoidPtr(&ZegoInternalCallbackCenter::zego_on_room_state_changed), ZegoVoidPtr(this));
                ...
                oInternalOriginBridge->registerPublisherStreamEventCallback(ZegoVoidPtr(&ZegoInternalCallbackCenter::zego_on_publisher_stream_event), ZegoVoidPtr(this));
                oInternalOriginBridge->registerPlayerStreamEventCallback(ZegoVoidPtr(&ZegoInternalCallbackCenter::zego_on_player_stream_event), ZegoVoidPtr(this));
                ...
                oInternalOriginBridge->registerPublisherVideoEncoderChangedCallback(ZegoVoidPtr(&ZegoInternalCallbackCenter::zego_on_publisher_video_encoder_changed), ZegoVoidPtr(this));
                ...
                oInternalOriginBridge->registerPlayerRecvAudioSideInfoCallback(ZegoVoidPtr(&ZegoInternalCallbackCenter::zego_on_player_recv_audio_side_info), ZegoVoidPtr(this));
...
#endif
                oInternalOriginBridge->registerPlayerLowFpsWarningCallback(ZegoVoidPtr(&ZegoInternalCallbackCenter::zego_on_player_low_fps_warning), ZegoVoidPtr(this));

                oInternalOriginBridge->registerLocalDeviceExceptionOccurredCallback(ZegoVoidPtr(&ZegoInternalCallbackCenter::zego_on_local_device_exception_occurred), ZegoVoidPtr(this));
                ...
                oInternalOriginBridge->registerCapturedSoundLevelInfoUpdateCallback(ZegoVoidPtr(&ZegoInternalCallbackCenter::zego_on_captured_sound_level_info_update), ZegoVoidPtr(this));
                oInternalOriginBridge->registerRemoteSoundLevelInfoUpdateCallback(ZegoVoidPtr(&ZegoInternalCallbackCenter::zego_on_remote_sound_level_info_update), ZegoVoidPtr(this));
                ...
                oInternalOriginBridge->registerAudioVADStateUpdateCallback(ZegoVoidPtr(&ZegoInternalCallbackCenter::zego_on_audio_vad_state_update), ZegoVoidPtr(this));

                oInternalOriginBridge->registerRealTimeSequentialDataSentCallback(ZegoVoidPtr(&ZegoInternalCallbackCenter::zego_on_real_time_sequential_data_sent), ZegoVoidPtr(this));
                oInternalOriginBridge->registerReceiveRealTimeSequentialDataCallback(ZegoVoidPtr(&ZegoInternalCallbackCenter::zego_on_receive_real_time_sequential_data), ZegoVoidPtr(this));
                ...
                oInternalOriginBridge->registerAutoMixerSoundLevelUpdateCallback(ZegoVoidPtr(&ZegoInternalCallbackCenter::zego_on_auto_mixer_sound_level_update), ZegoVoidPtr(this));
                ...
                oInternalOriginBridge->registerMediaPlayerSoundLevelUpdateCallback(ZegoVoidPtr(&ZegoInternalCallbackCenter::zego_on_media_player_sound_level_update), ZegoVoidPtr(this));
                oInternalOriginBridge->registerMediaPlayerFrequencySpectrumUpdateCallback(ZegoVoidPtr(&ZegoInternalCallbackCenter::zego_on_media_player_frequency_spectrum_update), ZegoVoidPtr(this));
                ...
                oInternalOriginBridge->registerRangeAudioMicrophoneStateUpdate(ZegoVoidPtr(&ZegoInternalCallbackCenter::zego_on_range_audio_microphone_state_update), ZegoVoidPtr(this));
                ...
                oInternalOriginBridge->registerProcessCapturedAudioDataAfterUsedHeadphoneMonitorCallback(ZegoVoidPtr(&ZegoInternalCallbackCenter::zego_on_process_captured_audio_data_after_used_headphone_monitor), ZegoVoidPtr(this));
                ...
                oInternalOriginBridge->registerProcessPlaybackAudioDataCallback(ZegoVoidPtr(&ZegoInternalCallbackCenter::zego_on_process_playback_audio_data), ZegoVoidPtr(this));
                ...
                oInternalOriginBridge->registerRecvExperimentalAPICallback(ZegoVoidPtr(&ZegoInternalCallbackCenter::zego_on_recv_experimental_api), ZegoVoidPtr(this));
                oInternalOriginBridge->registerNetworkQualityCallback(ZegoVoidPtr(&ZegoInternalCallbackCenter::zego_on_network_quality), ZegoVoidPtr(this));

                oInternalOriginBridge->registerCopyrightedMusicDownloadProcessUpdateCallback(ZegoVoidPtr(&ZegoInternalCallbackCenter::zego_on_copyrighted_music_download_progress_update), ZegoVoidPtr(this));
                oInternalOriginBridge->registerCopyrightedMusicCurrentPitchValueUpdateCallback(ZegoVoidPtr(&ZegoInternalCallbackCenter::zego_on_copyrighted_music_current_pitch_value_update), ZegoVoidPtr(this));
                oInternalOriginBridge->registerCopyrightedMusicInitCallback(ZegoVoidPtr(&ZegoInternalCallbackCenter::zego_on_copyrighted_music_init), ZegoVoidPtr(this));
                oInternalOriginBridge->registerCopyrightedMusicSendExtendedRequestCallback(ZegoVoidPtr(&ZegoInternalCallbackCenter::zego_on_copyrighted_music_send_extended_request), ZegoVoidPtr(this));
                oInternalOriginBridge->registerCopyrightedMusicGetLrcLyricCallback(ZegoVoidPtr(&ZegoInternalCallbackCenter::zego_on_copyrighted_music_get_lrc_lyric), ZegoVoidPtr(this));
                oInternalOriginBridge->registerCopyrightedMusicGetKrcLyricByTokenCallback(ZegoVoidPtr(&ZegoInternalCallbackCenter::zego_on_copyrighted_music_get_krc_lyric_by_token), ZegoVoidPtr(this));
                oInternalOriginBridge->registerCopyrightedMusicRequestSongCallback(ZegoVoidPtr(&ZegoInternalCallbackCenter::zego_on_copyrighted_music_request_song), ZegoVoidPtr(this));
                oInternalOriginBridge->registerCopyrightedMusicRequestAccompanimentCallback(ZegoVoidPtr(&ZegoInternalCallbackCenter::zego_on_copyrighted_music_request_accompaniment), ZegoVoidPtr(this));
                oInternalOriginBridge->registerCopyrightedMusicRequestAccompanimentClipCallback(ZegoVoidPtr(&ZegoInternalCallbackCenter::zego_on_copyrighted_music_request_accompaniment_clip), ZegoVoidPtr(this));
                oInternalOriginBridge->registerCopyrightedMusicGetMusicByTokenCallback(ZegoVoidPtr(&ZegoInternalCallbackCenter::zego_on_copyrighted_music_get_music_by_token), ZegoVoidPtr(this));
                oInternalOriginBridge->registerCopyrightedMusicGetStandardPitchCallback(ZegoVoidPtr(&ZegoInternalCallbackCenter::zego_on_copyrighted_music_get_standard_pitch), ZegoVoidPtr(this));
                oInternalOriginBridge->registerCopyrightedMusicDownloadCallback(ZegoVoidPtr(&ZegoInternalCallbackCenter::zego_on_copyrighted_music_download), ZegoVoidPtr(this));
                oInternalOriginBridge->registerNetworkTimeSynchronizedCallback(ZegoVoidPtr(&ZegoInternalCallbackCenter::zego_on_network_time_synchronized), ZegoVoidPtr(this));
#if ZEGO_EXPRESS_VIDEO_SDK
                oInternalOriginBridge->registerMediaDataPublisherFileCloseCallback(ZegoVoidPtr(&ZegoInternalCallbackCenter::zego_on_media_data_publisher_file_close), ZegoVoidPtr(this));
                oInternalOriginBridge->registerMediaDataPublisherFileOpenCallback(ZegoVoidPtr(&ZegoInternalCallbackCenter::zego_on_media_data_publisher_file_open), ZegoVoidPtr(this));
                oInternalOriginBridge->registerMediaDataPublisherFileDataBeginCallback(ZegoVoidPtr(&ZegoInternalCallbackCenter::zego_on_media_data_publisher_file_data_begin), ZegoVoidPtr(this));
#endif
            }
            ...
            void unregisterCallback()
            {
                ...
                oInternalOriginBridge->registerProcessCapturedAudioDataAfterUsedHeadphoneMonitorCallback(nullptr, nullptr);
                ...
                oInternalOriginBridge->registerCopyrightedMusicDownloadProcessUpdateCallback(nullptr, nullptr);
                oInternalOriginBridge->registerCopyrightedMusicCurrentPitchValueUpdateCallback(nullptr, nullptr);
                oInternalOriginBridge->registerCopyrightedMusicInitCallback(nullptr, nullptr);
                oInternalOriginBridge->registerCopyrightedMusicSendExtendedRequestCallback(nullptr, nullptr);
                ...
                oInternalOriginBridge->registerCopyrightedMusicRequestAccompanimentCallback(nullptr, nullptr);
                oInternalOriginBridge->registerCopyrightedMusicRequestAccompanimentClipCallback(nullptr, nullptr);
            ...
            static void zego_on_room_token_will_expire(const char* room_id, int remain_time_in_second, void* user_context)
            {
                ZEGO_UNUSED_VARIABLE(user_context);
                auto handler = oInternalCallbackCenter->getIZegoEventHandler();
                std::string roomID = room_id;
            ...
            static void zego_on_room_login_callback(zego_error error_code, const char * extended_data, const char * room_id, zego_seq seq, void * user_context)
            {
                ZEGO_UNUSED_VARIABLE(room_id);
                ZEGO_UNUSED_VARIABLE(user_context);
            ...
            static void zego_on_room_logout_callback(zego_error error_code, const char * extended_data, const char * room_id, zego_seq seq, void * user_context)
            {
                ZEGO_UNUSED_VARIABLE(room_id);
                ZEGO_UNUSED_VARIABLE(user_context);
                std::string extendedData = extended_data?extended_data:"";
            ...
            static void zego_on_room_state_changed(const char * room_id, enum zego_room_state_changed_reason reason, zego_error error_code, const char * extended_data, void * user_context)
            {
                ZEGO_UNUSED_VARIABLE(user_context);
                auto handler = oInternalCallbackCenter->getIZegoEventHandler();
                ...
                auto handlerInMain = weakHandler.lock();
                if (handlerInMain)
                    handlerInMain->onRoomStateChanged(roomID, ZegoRoomStateChangedReason(reason), error_code, extendData);
                ZEGO_SWITCH_THREAD_ING
            }
            ...
            static void zego_on_publisher_stream_event(enum zego_stream_event event_id, const char* stream_id, const char* extra_info, void *user_context)
            {
                ZEGO_UNUSED_VARIABLE(user_context);
                auto handler = oInternalCallbackCenter->getIZegoEventHandler();
                std::string streamID = stream_id;
            ...
            static void zego_on_player_stream_event(enum zego_stream_event event_id, const char* stream_id, const char* extra_info, void *user_context)
            {
                ZEGO_UNUSED_VARIABLE(user_context);
                auto handler = oInternalCallbackCenter->getIZegoEventHandler();
                std::string streamID = stream_id;
            ...
            static void zego_on_publisher_video_encoder_changed(enum zego_video_codec_id from_codec_id, enum zego_video_codec_id to_codec_id, enum zego_publish_channel channel, void *user_context)
            {
                ZEGO_UNUSED_VARIABLE(user_context);
                auto handler = oInternalCallbackCenter->getIZegoEventHandler();
                ...
                auto handlerInMain = weakHandler.lock();
                if (handlerInMain)
                    handlerInMain->onPublisherVideoEncoderChanged(static_cast<ZegoVideoCodecID>(from_codec_id), static_cast<ZegoVideoCodecID>(to_codec_id), static_cast<ZegoPublishChannel>(channel));
                ZEGO_SWITCH_THREAD_ING
            }
            ...
            static void zego_on_player_recv_audio_side_info(const char *stream_id, const unsigned char *data, unsigned int data_length, void *user_context)
            {
                ZEGO_UNUSED_VARIABLE(user_context);
                auto handler = oInternalCallbackCenter->getIZegoEventHandler();
                std::string streamID = stream_id;
                ...
                auto handlerInMain = weakHandler.lock();
                if (handlerInMain)
                    handlerInMain->onPlayerRecvAudioSideInfo(streamID, audioSideData.data(), ZegoUInt(audioSideData.size()));
                ZEGO_SWITCH_THREAD_ING
            }
            //#endif
            ...
            static void zego_on_player_low_fps_warning(zego_video_codec_id codec_id, const char *stream_id, void *user_context)
            {
                ZEGO_UNUSED_VARIABLE(user_context);
                auto handler = oInternalCallbackCenter->getIZegoEventHandler();
                std::string streamID = stream_id;
            ...
            static void zego_on_local_device_exception_occurred(enum zego_device_exception_type exception_type, enum zego_device_type device_type, const char * device_id, void * user_context) {
                ZEGO_UNUSED_VARIABLE(user_context);
                auto handler = oInternalCallbackCenter->getIZegoEventHandler();
                ...
                auto handlerInMain = weakHandler.lock();
                if (handlerInMain) {
                    handlerInMain->onLocalDeviceExceptionOccurred(ZegoDeviceExceptionType(exception_type), ZegoDeviceType(device_type), deviceId);
                }
                ZEGO_SWITCH_THREAD_ING
            }

            static void zego_on_device_error(zego_error error_code, const char *device_id, const char *device_name, void *user_context)
            {
                ZEGO_UNUSED_VARIABLE(user_context);
                auto handler = oInternalCallbackCenter->getIZegoEventHandler();
                ...
                if (handlerInMain) {
                    ...
                    handlerInMain->onDeviceError(error_code, device_id, deviceName);
                }
                ZEGO_SWITCH_THREAD_ING
            }
            ...
            static void zego_on_remote_speaker_state_update(const char *stream_id, zego_remote_device_state state, void *user_context)
            {
                ZEGO_UNUSED_VARIABLE(user_context);
                auto handler = oInternalCallbackCenter->getIZegoEventHandler();
                std::string streamID = stream_id;
            ...
            static void zego_on_captured_sound_level_info_update(const zego_sound_level_info *sound_level_info, void *user_context)
            {
                ZEGO_UNUSED_VARIABLE(user_context);
                auto handler = oInternalCallbackCenter->getIZegoEventHandler();
            ...
            static void  zego_on_remote_sound_level_info_update(const zego_sound_level_info *sound_level_info_list, unsigned int info_count, void *user_context)
            {
                ZEGO_UNUSED_VARIABLE(user_context);
                auto handler = oInternalCallbackCenter->getIZegoEventHandler();
            ...
            static void  zego_on_audio_vad_state_update(zego_audio_vad_stable_state_monitor_type monitor_type, zego_audio_vad_type type, void *user_context)
            {
                ZEGO_UNUSED_VARIABLE(user_context);
                auto handler = oInternalCallbackCenter->getIZegoEventHandler();
                auto weakHandler = std::weak_ptr<IZegoEventHandler>(handler);
                ...
                auto handlerInMain = weakHandler.lock();
                if (handlerInMain)
                    handlerInMain->onAudioVADStateUpdate((ZegoAudioVADStableStateMonitorType)monitor_type, (ZegoAudioVADType)type);
                ZEGO_SWITCH_THREAD_ING
            }
            ...
            static void zego_on_receive_real_time_sequential_data(int index, const unsigned char* data, unsigned int data_length, const char * stream_id, void * user_context)
            {
                ZEGO_UNUSED_VARIABLE(user_context);
                auto manager = oInternalCallbackCenter->getZegoExpressRealTimeSequentialDataManagerImp(index);
                if (manager)
                {
            ...
            static void zego_on_real_time_sequential_data_sent(zego_error error_code, int index, zego_seq seq, void * user_context)
            {
                ZEGO_UNUSED_VARIABLE(user_context);
                auto manager = oInternalCallbackCenter->getZegoExpressRealTimeSequentialDataManagerImp(index);
                if (manager)
            ...
            static void zego_on_auto_mixer_sound_level_update(const struct zego_sound_level_info* sound_levels, unsigned int info_count, void * user_context)
            {
                ZEGO_UNUSED_VARIABLE(user_context);
                auto handler = oInternalCallbackCenter->getIZegoEventHandler();
            ...
            static void zego_on_media_player_sound_level_update(float sound_level, enum zego_media_player_instance_index instance_index, void * user_context)
            {
                ZEGO_UNUSED_VARIABLE(user_context);
                auto mediaPlayer = oInternalCallbackCenter->getZegoExpressMediaPlayerImp(instance_index);
                if (mediaPlayer)
            ...
            static void zego_on_media_player_frequency_spectrum_update(float* spectrum_list, unsigned int spectrum_count, enum zego_media_player_instance_index instance_index, void * user_context)
            {
                ZEGO_UNUSED_VARIABLE(user_context);
                auto mediaPlayer = oInternalCallbackCenter->getZegoExpressMediaPlayerImp(instance_index);
                if (mediaPlayer)
                {
                    mediaPlayer->zego_on_media_player_frequency_spectrum_update(spectrum_list, spectrum_count);
                }
            }
...
#if ZEGO_EXPRESS_VIDEO_SDK
            static void zego_on_media_player_video_frame(const unsigned char **data, unsigned int *data_length, const struct zego_video_frame_param param, const char* extra_info, enum zego_media_player_instance_index instance_index, void *user_context)
            {
                ZEGO_UNUSED_VARIABLE(user_context);
                auto mediaPlayer = oInternalCallbackCenter->getZegoExpressMediaPlayerImp(instance_index);
                if (mediaPlayer)
            ...
            static void zego_on_range_audio_microphone_state_update(enum zego_range_audio_microphone_state state, zego_error error_code, enum zego_range_audio_instance_index instance_index, void * user_context)
            {
                ZEGO_UNUSED_VARIABLE(user_context);
            ...
            static void zego_on_process_captured_audio_data(unsigned char *data, unsigned int data_length, struct zego_audio_frame_param *_param, double timestamp, void *user_context)
            {
                ZEGO_UNUSED_VARIABLE(user_context);
            ...
            static void zego_on_process_captured_audio_data_after_used_headphone_monitor(unsigned char *data, unsigned int data_length, struct zego_audio_frame_param *_param, double timestamp, void *user_context)
            {
                ZEGO_UNUSED_VARIABLE(user_context);
                auto handler = oInternalCallbackCenter->getIZegoCustomAudioProcessHandler();
                if (handler)
                {
                    ZegoAudioFrameParam param = ZegoExpressConvert::I2OAudioFrameParam(*_param);
                    handler->onProcessCapturedAudioDataAfterUsedHeadphoneMonitor(data, data_length, &param, timestamp);
                    *_param = ZegoExpressConvert::O2IAudioFrameParam(param);
                }
            }

            static void zego_on_process_remote_audio_data(unsigned char *data, unsigned int data_length, struct zego_audio_frame_param *_param, const char *stream_id, double timestamp, void *user_context)
            {
                ZEGO_UNUSED_VARIABLE(user_context);
                auto handler = oInternalCallbackCenter->getIZegoCustomAudioProcessHandler();
                if (handler)
            ...
            static void zego_on_process_playback_audio_data(unsigned char *data, unsigned int data_length, struct zego_audio_frame_param *_param, double timestamp, void *user_context)
            {
                ZEGO_UNUSED_VARIABLE(user_context);
                auto handler = oInternalCallbackCenter->getIZegoCustomAudioProcessHandler();
                if (handler)
            ...
            static void zego_on_network_quality(const char * user_id, enum zego_stream_quality_level upstream_quality, enum zego_stream_quality_level downstream_quality, void* user_context)
            {
                ZEGO_UNUSED_VARIABLE(user_context);
                ...
                if (handler) {
                    ...
                    handler->onNetworkQuality(userID.c_str(), int(upstreamQuality), int(downstreamQuality)); // Deprecated
                }
                ZEGO_SWITCH_THREAD_ING
            }

            static void zego_on_copyrighted_music_download_progress_update(zego_seq seq, const char * resource_id, float progress_rate, void * user_context)
            {
                ZEGO_UNUSED_VARIABLE(user_context);
                ...
                if (copyrightedMusic)
                {
                    copyrightedMusic->zego_on_copyrighted_music_download_progress_update(resource_id, progress_rate);
                }
            }

            static void zego_on_copyrighted_music_current_pitch_value_update(const char * resource_id, int current_duration, int pitch_value, void * user_context)
            {
                ZEGO_UNUSED_VARIABLE(user_context);
                auto copyrightedMusic = oInternalCallbackCenter->getZegoExpressCopyrightedMusicImp();
                ...
                if (copyrightedMusic)
                {
                    copyrightedMusic->zego_on_copyrighted_music_current_pitch_value_update(resource_id, current_duration, pitch_value);
                }
            }

            static void zego_on_copyrighted_music_init(zego_seq seq, zego_error error_code, void * user_context)
            {
                ZEGO_UNUSED_VARIABLE(user_context);
                auto copyrightedMusic = oInternalCallbackCenter->getZegoExpressCopyrightedMusicImp();
            ...
            static void zego_on_copyrighted_music_send_extended_request(zego_seq seq, zego_error error_code, const char * command, const char * result, void * user_context)
            {
                ZEGO_UNUSED_VARIABLE(user_context);
                auto copyrightedMusic = oInternalCallbackCenter->getZegoExpressCopyrightedMusicImp();
                ...
                if (copyrightedMusic)
                {
                    copyrightedMusic->zego_on_copyrighted_music_send_extended_request(seq, error_code, command, result);
                }
            }

            static void zego_on_copyrighted_music_get_lrc_lyric(zego_seq seq, zego_error error_code, const char * lyrics, void * user_context)
            {
                ZEGO_UNUSED_VARIABLE(user_context);
                auto copyrightedMusic = oInternalCallbackCenter->getZegoExpressCopyrightedMusicImp();
            ...
            static void zego_on_copyrighted_music_get_krc_lyric_by_token(zego_seq seq, zego_error error_code, const char * lyrics, void * user_context)
            {
                ZEGO_UNUSED_VARIABLE(user_context);
                auto copyrightedMusic = oInternalCallbackCenter->getZegoExpressCopyrightedMusicImp();
                ...
                if (copyrightedMusic)
                {
                    copyrightedMusic->zego_on_copyrighted_music_get_krc_lyric_by_token(seq, error_code, lyrics);
                }
            }

            static void zego_on_copyrighted_music_request_song(zego_seq seq, zego_error error_code, const char * resource_id, void * user_context)
            {
                ZEGO_UNUSED_VARIABLE(user_context);
                auto copyrightedMusic = oInternalCallbackCenter->getZegoExpressCopyrightedMusicImp();
            ...
            static void zego_on_copyrighted_music_request_accompaniment(zego_seq seq, zego_error error_code, const char * resource_id, void * user_context)
            {
                ZEGO_UNUSED_VARIABLE(user_context);
                auto copyrightedMusic = oInternalCallbackCenter->getZegoExpressCopyrightedMusicImp();
                ...
                if (copyrightedMusic)
                {
                    copyrightedMusic->zego_on_copyrighted_music_request_accompaniment(seq, error_code, resource_id);
                }
            }

            static void zego_on_copyrighted_music_request_accompaniment_clip(zego_seq seq, zego_error error_code, const char* resource_id, void* user_context)
            {
                ZEGO_UNUSED_VARIABLE(user_context);
                auto copyrightedMusic = oInternalCallbackCenter->getZegoExpressCopyrightedMusicImp();
                ...
                if (copyrightedMusic)
                {
                    copyrightedMusic->zego_on_copyrighted_music_request_accompaniment_clip(seq, error_code, resource_id);
                }
            }

            static void zego_on_copyrighted_music_get_music_by_token(zego_seq seq, zego_error error_code, const char * resource_id, void * user_context)
            {
                ZEGO_UNUSED_VARIABLE(user_context);
                auto copyrightedMusic = oInternalCallbackCenter->getZegoExpressCopyrightedMusicImp();
                ...
                if (copyrightedMusic)
                {
                    copyrightedMusic->zego_on_copyrighted_music_get_music_by_token(seq, error_code, resource_id);
                }
            }

            static void zego_on_copyrighted_music_download(zego_seq seq, zego_error error_code, void * user_context)
            {
                ZEGO_UNUSED_VARIABLE(user_context);
                auto copyrightedMusic = oInternalCallbackCenter->getZegoExpressCopyrightedMusicImp();
            ...
            static void zego_on_copyrighted_music_get_standard_pitch(zego_seq seq, zego_error error_code, const char * pitch, void * user_context)
            {
                ZEGO_UNUSED_VARIABLE(user_context);
                auto copyrightedMusic = oInternalCallbackCenter->getZegoExpressCopyrightedMusicImp();
...
#if ZEGO_EXPRESS_VIDEO_SDK
            static void zego_on_media_data_publisher_file_open(const char * path, zego_instance instance_index, void * user_context)
            {
                ZEGO_UNUSED_VARIABLE(user_context);

                auto media_data_publisher_ins = oInternalCallbackCenter->getZegoExpressMediaDataPublisherImp(instance_index);
                ...
                if(media_data_publisher_ins)
                {
                    ...
                    media_data_publisher_ins->zego_on_media_data_publisher_file_open(file_path, instance_index);
                }
            }

            static void zego_on_media_data_publisher_file_close(zego_error error_code, const char * path, zego_instance instance_index, void * user_context)
            {
                ZEGO_UNUSED_VARIABLE(user_context);
                ...
                if(media_data_publisher_ins)
                {
                    ...
                    media_data_publisher_ins->zego_on_media_data_publisher_file_close(error_code, file_path, instance_index);
                }
            }

            static void zego_on_media_data_publisher_file_data_begin(const char * path, zego_instance instance_index, void * user_context)
            {
                ZEGO_UNUSED_VARIABLE(user_context);
                ...
                if(media_data_publisher_ins)
                {
                    ...
                    media_data_publisher_ins->zego_on_media_data_publisher_file_data_begin(file_path, instance_index);
                }
            }
#endif
        };
