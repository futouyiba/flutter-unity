 ...
 */
ZEGOEXP_API zego_error EXP_CALL zego_express_start_network_speed_test(struct zego_network_speed_test_config config, unsigned int interval);
 ...
 * Restrictions: None.
 */
ZEGOEXP_API zego_error EXP_CALL zego_express_get_network_time_info(zego_network_time_info * time_info);
