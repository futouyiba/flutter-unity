 ...
 * @param channel Publishing stream channel
 */
ZEGOEXP_API zego_error EXP_CALL zego_express_set_custom_video_capture_rotation(int rotation, enum zego_publish_channel channel);
 ...
 * @param channel Publishing stream channel
 */
ZEGOEXP_API zego_error EXP_CALL zego_express_set_custom_video_capture_device_state(bool is_enable, enum zego_remote_device_state state, enum zego_publish_channel channel);
 ...
 * @param channel Publishing stream channel.
 */
ZEGOEXP_API zego_error EXP_CALL zego_express_set_custom_video_capture_transform_matrix(float matrix[16], enum zego_publish_channel channel);
 ...
 * @param channel Publish channel
 */
ZEGOEXP_API zego_error EXP_CALL zego_express_set_custom_video_capture_region_of_interest(struct zego_roi_rect * rect_list, unsigned int rect_count, enum zego_publish_channel channel);
...
/**
 * When the custom video rendering is enabled, the data of the local preview video frame after encoding is called back.
 *
 * Available since: 1.1.0
 * Description: When custom video rendering is enabled, the local preview video frame encoded data callback will be rendered by the developer.
 ...
 * When to Trigger: When the local preview is enabled, the SDK collects the local preview video frame data.
 * Related APIs: Call [setCustomVideoRenderHandler] to set custom video rendering callback.
 *
